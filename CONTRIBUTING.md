...
issue](https://github.com/CuiweiG/survinger/issues/new) with a minimal
reproducible example. The [reprex](https://reprex.tidyverse.org/)
...
Conduct](https://cuiweig.github.io/survinger/CODE_OF_CONDUCT.md). By
